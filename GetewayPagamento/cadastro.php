        ...
        <div class="contecao">
            <form action="cadastrarBD.php" method="post">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="cpf" required>
                </div>
                <br>
                <div class="mb-3">
                ...
                <br>
                <div>
                    <label>Já possuo conta, <a href="index.php" class="styleentCad">Entrar</a></label>
                </div>
                <br>
            ...
            <div class="container pt-5 border-bottom">
              <div class="row">
                <div class="col-md-3 col-sm-12 mb-3 text-center">
                    <h5 class="mb-4 font-weight-bold text-uppercase">Geteway Pagamentos</h5>
                          <defs>
                ...
                <div class="col-md-9 col-sm-12">
                  ...
                  <ul class="list-group">
                    ...
                    <li class="list-group-item bg-transparent border-0 p-0 mb-2">
                      <a href="https://github.com/LeoCortarelli" target="_blank"><i class="fa fa-github mr-1"></i> Github</a>  
                    </li>
                    <li class="list-group-item bg-transparent border-0 p-0 mb-2">
